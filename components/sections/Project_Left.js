...
export default function Project_Left({subTitle, title, description, features, images}) {
                ...
                <div className="col-lg-6">
                    <div className="images layout-03">
                        <div className="inner">
                            ...
                            <img className="img15 wow animate__animated animate__fadeInLeft" src={images.image1} alt="Banner" />
                            <img className="img16 wow animate__animated animate__fadeInUp" src={images.image2} alt="Banner" />
                            <img className="img16_2 wow animate__animated animate__fadeInRight" src={images.image3} alt="Banner" />
                        </div>
                    </div>
                </div>
                <div className="col-lg-6">
